employees = Employee.create([
  ...
  },
  {
    ...
    phone: '720-541-1290',
    image: 'https://images.unsplash.com/photo-1618747946260-9511b46b1ac7?ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mzc4fHxwb3J0YWl0fGVufDB8fDB8fA%3D%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60',
    hire_date: Date.parse('5/8/2019'),
    training: false,
    address: {
      'state'=> 'Colorado',
      'city'=> 'Boulder',
      'streeet_address' => '6578 Mapleton Ave',
      'zip' => '80304'
    }
  },
])